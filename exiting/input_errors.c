...
/*   Updated: 2025/10/20 23:04:25 by havr             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 *
 * @param word
 * @param append flag to evaluate also the heredoc as it could be in and end
 * position, unless there are two in a row.
 * @return int
 */
...
/**
 * @brief Validates pipe and redirection operator syntax
 * @param current Pointer to the current token in the token list
 *
